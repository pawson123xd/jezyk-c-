...
namespace WinFormsApp2
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            this.KeyPreview = true;            // wa¿ne, ¿eby form przekazywa³ KeyDown
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sieæ Siec = new sieæ(wagi_miejsce, bias_miejsce, warstwy);
                wyswietl.Text ="";
        ...
        private List<double[]> wycztaj1(int[,] wejscia, int ile_warst)
        {
            ...
            for (int i = 0; i < ile_warst; i++)
            {
                ...
                // czekamy, a¿ u¿ytkownik wciœnie Enter
                while (!enterPressed)
                {
                    Application.DoEvents();
                    System.Threading.Thread.Sleep(10);  // odrobina pauzy, by nie “zapchaæ” CPU
                }
...
class sieæ :Form1
{
    ...
    public double[] wagi;
    public double[] bias;
    public sieæ(int wagi_miejsce, int bias_miejsce, List<double[]> warstwy) 
    {
